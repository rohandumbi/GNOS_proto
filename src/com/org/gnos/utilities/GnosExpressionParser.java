...
public class GnosExpressionParser {
	...
	//private static Node topNode = new Node();
	...
	static boolean evaluateNew(String or){
		/*if ((vars.length % 2 == 1 || vars.length < 2) && vars.length != 0)
		{
			System.err.println("ERROR: Invalid arguments!");
			return false;
	...
	private static boolean parseWithStrings(String s){
		...
		//System.out.println("My left:" + leftSansParen + " My Right: " + rightSansParen);
		return true;
	}
	
	private static void parseWithStrings(Node parentNode, String s){
	...
	public static void main(String[] args) {
		...
		//GnosExpressionParser.evaluate("2+[x] == [y] && (1==1 && Joe==Joe && 3^2>10)", "x", 5, "y", 7);
		GnosExpressionParser.evaluateNew("2>3 && (1==1 && Joe==Joe && 3^2>10)");
	}
