...
public class ScenarioDAO {
	...
	private static final String SQL_LIST_ORDER_BY_MODIFIED_DATE = "select id, name, project_id, start_year, time_period, discount from  scenario where projectId = ?";
	private static final String SQL_INSERT = "insert into scenario (name, start_year, time_period, discount) values (?, ?, ?, ?)";
