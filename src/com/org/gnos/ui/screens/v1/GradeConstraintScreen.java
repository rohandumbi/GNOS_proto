...
public class GradeConstraintScreen extends GnosScreen {
	 ...
	 * @param style
	 */
	public GradeConstraintScreen(Composite parent, int style) {
		super(parent, style);
	...
	private void createContent(){
		...
		labelScreenDescription.setText("Define your grade contraints.");
