...
public class BenchConstraintScreen extends GnosScreen {
	 ...
	 * @param style
	 */
	public BenchConstraintScreen(Composite parent, int style) {
		super(parent, style);
	...
	private void createContent(){
		...
		labelScreenDescription.setText("Define your pit-bench contraints.");
