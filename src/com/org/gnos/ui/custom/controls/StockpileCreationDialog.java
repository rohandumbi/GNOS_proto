...
public class StockpileCreationDialog extends Dialog {
	...
	private StockpileDefinitionGrid stockpileDefinitionGrid;
	private Button btnAddStockpile;
	...
	protected Control createDialogArea(Composite parent) {
		...
		labelScreenName.setText("Stockpile Definition Dialog");
		...
		labelScreenDescription.setText("Add/Modify Stockpiles");
	...
	private void initializeGridContainer(){
		...
		this.btnAddStockpile = new Button(this.container, SWT.NONE);
		this.btnAddStockpile.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				//TO DO implement row add
				stockpileDefinitionGrid.addRow();
				Rectangle r = stockpileDefinitionGrid.getClientArea();
		...
		this.btnAddStockpile.setFont(SWTResourceManager.getFont("Segoe UI", 16, SWT.BOLD));
		...
		this.btnAddStockpile.setLayoutData(fd_btnAddRow);
		this.btnAddStockpile.setText("+");
		
	}
	
	public void refreshGrid(){
		if(this.stockpileDefinitionGrid != null){
			this.stockpileDefinitionGrid.dispose();
		}
		this.stockpileDefinitionGrid = new StockpileDefinitionGrid(scGridContainer, SWT.None);
		this.scGridContainer.setContent(this.stockpileDefinitionGrid);
	}
