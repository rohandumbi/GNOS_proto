...
/*	static <T> boolean evaluate(String str, String[] values, List<Integer> columnIds){
	...
	public static void main(String[] args) {
		...
		//System.out.println(GnosExpressionParser.evaluate("2+[x] == [y] && (1==1 && Joe==Joe && 3^2>[y])", "x", 5, "y", 7));
		//GnosExpressionParser.evaluate("2>3 && (1==1 && Joe==Joe && 3^2>10) && (True==True)");
	}
